...
namespace GameOn
{
    ...
    /// </summary>
    public class GameOn : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            score4.position = new Vector3(30, 0, -100);
            score4.visible = true;

            score5.model = Content.Load<Model>("Gun");
            score5.position = new Vector3(20, 0, -120);
            score5.visible = true;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Vector3.Distance(score.position, cameraPosition) < 10 && score.visible == true)
            {
                scoretotal = scoretotal + 1;
                score.visible = false;
            }
            if (Vector3.Distance(score2.position, cameraPosition) < 10 && score2.visible == true)
            {
                scoretotal = scoretotal + 1;
                score2.visible = false;
            }
            if (Vector3.Distance(score3.position, cameraPosition) < 10 && score3.visible == true)
            {
                scoretotal = scoretotal + 1;
                score3.visible = false;
            }
            if (Vector3.Distance(score4.position, cameraPosition) < 10 && score4.visible == true)
            {
                scoretotal = scoretotal + 1;
                score4.visible = false;
            }
            if (Vector3.Distance(score5.position, cameraPosition) < 10 && score5.visible == true)
            {
                scoretotal = scoretotal + 1;
           ...
           // if (cameraPosition.X == wall.position.X)
            //{
             //   cameraRotation = 0;
             //   UpdateCamera();
            //}
            //if (cameraPosition.Z == wall.position.X)
            //{
            //    cameraRotation = 0;
            //    UpdateCamera();
            //}
            ...
            if (Vector3.Distance(enemy.position, cameraPosition) < 10)
            {
                cameraPosition.Z += 50;
            }
            if (Vector3.Distance(enemy2.position, cameraPosition) < 10)
            {
                cameraPosition.Z += 50;
            }
            if (Vector3.Distance(enemy3.position, cameraPosition) < 10)
            {
                cameraPosition.Z += 50;
            }
            if (Vector3.Distance(enemy4.position, cameraPosition) < 10)
            {
                cameraPosition.Z += 50;
            }
            if (Vector3.Distance(enemy5.position, cameraPosition) < 10)
            {
                cameraPosition.Z += 50;
            }
